...
/*        ArrayList<String> listUpperCase = new ArrayList<String>();
        ...
        */
        ArrayList<String> listCopyOfString = new ArrayList<String>();
        for (int i = 0; i < list.size(); i++)
        {
            String s = list.get(i);
            if(s.length() %2 == 0)
        ...
        for (int i = 0; i < listCopyOfString.size(); i++)
        {
            System.out.println(listCopyOfString.get(i));
        }
    }
}
