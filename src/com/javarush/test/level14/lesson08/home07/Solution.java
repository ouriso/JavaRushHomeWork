...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for(Apartament aps : apartaments)
        {
            if(aps instanceof Apt1Room) ((Apt1Room) aps).clean1Room();
            if(aps instanceof Apt2Room) ((Apt2Room) aps).clean2Rooms();
            if(aps instanceof Apt3Room) ((Apt3Room) aps).clean3Rooms();
        }
    }
